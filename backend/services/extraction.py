...
_SYS_EXTRACT = (
    ...
    "Trích xuất toàn bộ tiêu chuẩn đánh giá trong HSMT và phân vào 4 nhóm: "
    "hop_le, nang_luc, ky_thuat, tai_chinh. Chỉ trả về JSON."
)
_SYS_MAP = (
    "Bạn là chuyên gia đấu thầu. Với mỗi tiêu chuẩn đánh giá, tìm nội dung tương ứng "
